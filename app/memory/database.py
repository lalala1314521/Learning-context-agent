...
def init_db() -> None:
    ...
    try:
        ...
        _ensure_column(conn, "graph_nodes", "relation_type", "TEXT DEFAULT 'related'")
        _ensure_column(conn, "graph_nodes", "relation_status", "TEXT DEFAULT 'pending'")
        _ensure_column(conn, "graph_nodes", "evidence", "TEXT")
