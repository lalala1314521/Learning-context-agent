...
function SourceCard({ source, index, onOpen }: { source: AskResult["sources"][number]; index: number; onOpen: (graphId: string) => void }) {
  ...
  return <button className="source-card" onClick={() => source.graph_id && onOpen(source.graph_id)} disabled={!source.graph_id}>{content}</button>;
}
